...
function runAnimationLoop(){
  ...
  creative.MainTimeline
    ...
    .set( creative.dom.cursor, {left: 10,delay:1.5}, 'letterone')

    .addLabel('lettertwo')
    .to( creative.dom.email.lettertwo, 0.1, {autoAlpha:1}, 'lettertwo' )
    .set( creative.dom.cursor, {left: 18}, 'lettertwo')

    .addLabel('letterthree')
    .to( creative.dom.email.letterthree, 0.1, {autoAlpha:1}, 'letterthree' )
    .set( creative.dom.cursor, {left: 28}, 'letterthree')

    .addLabel('letterfour')
    .to( creative.dom.email.letterfour, 0.1, {autoAlpha:1}, 'letterfour' )
    .set( creative.dom.cursor, {left: 36}, 'letterfour')

    .addLabel('at')
    .to( creative.dom.at, 0.1, {autoAlpha:1}, 'at' )
    .set( creative.dom.cursor, {left: 60}, 'at')

    .addLabel('dot')
    .to( creative.dom.dot, 0.1, {autoAlpha:1,delay:0.5}, 'dot' )
    .set( creative.dom.cursor, {left: 200,delay:0.5}, 'dot')

    .addLabel('c')
    .to( creative.dom.c, 0.1, {autoAlpha:1}, 'c')
    .set( creative.dom.cursor, {left: 220}, 'c')

    .addLabel('o')
    .to( creative.dom.o, 0.1, {autoAlpha:1}, 'o')
    .set( creative.dom.cursor, {left: 230}, 'o')

    .addLabel('m')
    .to( creative.dom.m, 0.2, {autoAlpha:1}, 'm')
    .set( creative.dom.cursor, {left: 250}, 'm')

    .addLabel('slide-one')
    .to(  creative.dom.bgImg, 1, {left: -80, ease: Power3.easeIn, delay:1},'slide-one')
    .to(creative.dom.email.left, 1, {left:40, ease: Power3.easeIn, delay:1},'slide-one')
    .to(creative.dom.email.right, 1, {left:240, ease: Power3.easeIn, delay:1},'slide-one')
    .to(creative.dom.whiteBg, 1,{left:310, ease: Power3.easeIn, delay:1},'slide-one' )
