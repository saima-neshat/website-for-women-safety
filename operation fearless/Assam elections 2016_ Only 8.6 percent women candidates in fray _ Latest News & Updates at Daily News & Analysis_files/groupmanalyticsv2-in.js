//var gmScriptName = 'groupmanalyticsV2-in.js';
// Turbine code

function gmtagr()
{
    // set core tagr variables
	this.gmScriptName = 'groupmanalyticsV2-in.js'; // This parameter needs to match the name of the JS file *as saved to the CDN*
    ...
    this.tagid = 'V2_7502'; // Use the tag id from the tag generated in the UI
